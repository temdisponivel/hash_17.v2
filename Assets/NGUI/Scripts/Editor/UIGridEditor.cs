...
public class UIGridEditor : UIWidgetContainerEditor
{
	public override void OnInspectorGUI ()
	{
		...
		var sp = NGUIEditorTools.DrawProperty("Arrangement", serializedObject, "arrangement");
		...
		if (sp.intValue < 2)
		{
			var columns = (sp.hasMultipleDifferentValues || (UIGrid.Arrangement)sp.intValue == UIGrid.Arrangement.Horizontal);
			...
			var sort = (UIGrid.Sorting)NGUIEditorTools.DrawProperty("Sorting", serializedObject, "sorting").intValue;
