...
public class UIRootEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		var sp = NGUIEditorTools.DrawProperty("Scaling Style", serializedObject, "scalingStyle");

		var scaling = (UIRoot.Scaling)sp.intValue;
		...
		else
		{
			...
			var fitWidth = NGUIEditorTools.DrawProperty("Fit", serializedObject, "fitWidth").boolValue;
			NGUIEditorTools.SetLabelWidth(110f);
			...
			NGUIEditorTools.SetLabelWidth(26f);
			var fitHeight = NGUIEditorTools.DrawProperty("Fit", serializedObject, "fitHeight").boolValue;
			NGUIEditorTools.SetLabelWidth(110f);
			GUILayout.EndHorizontal();
