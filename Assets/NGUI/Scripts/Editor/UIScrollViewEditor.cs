...
public class UIScrollViewEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		var sppv = serializedObject.FindProperty("contentPivot");
		var before = (UIWidget.Pivot)sppv.intValue;

		NGUIEditorTools.DrawProperty("Content Origin", sppv, false);

		var sp = NGUIEditorTools.DrawProperty("Movement", serializedObject, "movement");
