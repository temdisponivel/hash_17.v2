...
public class UILabelInspector : UIWidgetInspector
{
	...
	void OnUnityFont (Object obj)
	{
		...
		var sp = serializedObject.FindProperty("mTrueTypeFont");
		sp.objectReferenceValue = obj;
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		{
			var uiFont = (fnt != null) ? fnt.objectReferenceValue as UIFont : null;
			...
			var ww = GUI.skin.textField.wordWrap;
			GUI.skin.textField.wordWrap = true;
			var sp = serializedObject.FindProperty("mText");
			...
			else
			{
				...
				var height = style.CalcHeight(new GUIContent(sp.stringValue), Screen.width - 100f);
				var offset = true;
				...
				GUI.changed = false;
				var text = EditorGUI.TextArea(rect, sp.stringValue, style);
			...
			var ov = NGUIEditorTools.DrawPaddedProperty("Overflow", serializedObject, "mOverflow");
			...
			GUILayout.BeginHorizontal();
			var gr = NGUIEditorTools.DrawProperty("Gradient", serializedObject, "mApplyGradient",
			GUILayout.Width(95f));
