...
public class UIAtlasInspector : Editor
{
	...
	public override void OnPreviewGUI (Rect rect, GUIStyle background)
	{
		...
		var tex = mAtlas.texture as Texture2D;
	...
	void AddClampedBorder (UISpriteData sprite)
	{
		...
		if (se != null)
		{
			var w1 = se.tex.width - se.borderLeft - se.borderRight;
			var h1 = se.tex.height - se.borderBottom - se.borderTop;

			var w2 = se.tex.width + 2;
			var h2 = se.tex.height + 2;
			...
			{
				var y1 = se.borderBottom + NGUIMath.ClampIndex(y2 - se.borderBottom - 1, h1);

				for (var x2 = 0; x2 < w2; ++x2)
				{
					var x1 = se.borderLeft + NGUIMath.ClampIndex(x2 - se.borderLeft - 1, w1);
	...
	void AddTiledBorder (UISpriteData sprite)
	{
		...
		if (se != null)
		{
			...
			for (var y2 = 0; y2 < h2; ++y2)
			{
				var y1 = se.borderBottom + NGUIMath.RepeatIndex(y2 - se.borderBottom - 1, h1);

				for (var x2 = 0; x2 < w2; ++x2)
				{
					var x1 = se.borderLeft + NGUIMath.RepeatIndex(x2 - se.borderLeft - 1, w1);
					c2[x2 + y2 * w2] = c1[x1 + y1 * se.tex.width];
				}
			}
	...
	void CropBorder (UISpriteData sprite)
	{
		...
		if (se != null)
		{
			...
			var w2 = w1 - se.borderLeft - se.borderRight;
			var h2 = h1 - se.borderTop - se.borderBottom;
			...
			for (var y2 = 0; y2 < h2; ++y2)
			{
				var y1 = y2 + se.borderBottom;

				for (var x2 = 0; x2 < w2; ++x2)
				{
					var x1 = x2 + se.borderLeft;
