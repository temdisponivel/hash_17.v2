...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		var sp = NGUIEditorTools.DrawProperty("Type", serializedObject, "mType", GUILayout.MinWidth(20f));

		var type = (UISprite.Type)sp.intValue;
		...
		else if (type == UISprite.Type.Sliced)
		{
			...
			EditorGUI.BeginDisabledGroup(sp.hasMultipleDifferentValues);
			{
				...
				var val = (sp.intValue != (int)UISprite.AdvancedType.Invisible);
		...
		{
			GUILayout.BeginHorizontal();
			var gr = NGUIEditorTools.DrawProperty("Gradient", serializedObject, "mApplyGradient", GUILayout.Width(95f));
