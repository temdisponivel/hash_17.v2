...
#else
				var source = mListener.GetComponent<AudioSource>();
#endif
...
//    }
	...
	static public UIPanel CreateUI (Transform trans, bool advanced3D, int layer)
	{
		...
		var root = (trans != null) ? NGUITools.FindInParents<UIRoot>(trans.gameObject) : null;
		...
		if (root == null)
		{
			var go = NGUITools.AddChild(null, false);
		...
		if (panel == null)
		{
			...
			var cameras = NGUITools.FindActive<Camera>();
			...
			var cam = NGUITools.AddChild<Camera>(root.gameObject, false);
			...
			var listeners = NGUITools.FindActive<AudioListener>();
